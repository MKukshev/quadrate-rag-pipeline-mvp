# NVIDIA MIG Setup Guide для RTX 6000 Ada 96GB
...
## 📊 MIG Profiles для RTX 6000 Ada 96GB
...
Теперь вы можете эффективно использовать RTX 6000 Ada 96GB с MIG для запуска нескольких vLLM инстансов!
